    ...
    <main className={styles.layout_main}>
      <Card className={styles.card_privacy}>
        ...
        <section>
          ...
          <p>
            Este site não utiliza cookies de marketing, rastreamento ou análise.
            Sua navegação é privada e não criamos perfis de usuário.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            ...
            infraestrutura da Vercel pode processar automaticamente certos dados
            técnicos, tais como:
          </p>
          <ul>
            <li>
              Endereço IP (utilizado para segurança e geolocalização aproximada
          ...
          <p>
            ...
            monitoramento de performance, diagnóstico de erros e proteção contra
            acessos maliciosos. Nós não utilizamos esses dados para identificar
            você pessoalmente. Para mais detalhes, você pode consultar a
        ...
        <section>
          ...
          <p>
            Caso este site contenha links para serviços externos, lembramos que
            não temos controle sobre as políticas de privacidade desses
            terceiros.
          </p>
        </section>
