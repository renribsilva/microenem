    ...
    <div className={styles.layout_container}>
      ...
      <main className={styles.layout_main}>
        <Card className={styles.card_privacy}>
          ...
          <p>Esta política descreve como tratamos as informações no site <strong>microenem.vercel.app</strong></p>
          ...
          <section>
            ...
            <ul>
              ...
              <li>Não realizamos o rastreamento de suas atividades de navegação.</li>
            </ul>
          </section>

          <section>
            <h2>2. Uso de Cookies</h2>
            <p>Este site não utiliza cookies de marketing, rastreamento ou análise. Sua navegação é privada e não criamos perfis de usuário.</p>
          </section>
          ...
          <section>
            ...
            <ul>
              <li>Endereço IP (utilizado para segurança e geolocalização aproximada para entrega de conteúdo).</li>
          ...
          <section>
            ...
            <p>Caso este site contenha links para serviços externos, lembramos que não temos controle sobre as políticas de privacidade desses terceiros.</p>
          </section>

          <section>
            <h2>5. Alterações nesta Política</h2>
            <p>Esta política pode ser atualizada ocasionalmente. O compromisso de não coletar dados desnecessários permanece.</p>
